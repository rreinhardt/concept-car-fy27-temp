              ...
              <div key={step.id} className="seq-step-wrapper">
                ...
                <div className="seq-step-header">
                  <div className="seq-step-header-left">
                    ...
                    <Badge size="sm">{step.label} ↓</Badge>
                    <Badge size="sm">{step.format} ↓</Badge>
                    {step.signals > 0 && (
                      <Badge size="sm">Signals {step.signals} ↓</Badge>
                    )}
                  </div>
