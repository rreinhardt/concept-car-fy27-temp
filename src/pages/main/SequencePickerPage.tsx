  ...
  return (
    <div className="search-page">
      ...
      <div className="search-page-header">
        <h2 className="text-title-md">Sequences</h2>
      ...
      <div className="search-body">
        ...
        {/* Main content — white round rect */}
        <div className="search-main seqp-main-wrapper">
          ...
          {/* Preview panel — overlays the white round rect from the left */}
          <div className={`seqp-preview-panel ${selected ? 'seqp-preview-panel-open' : ''}`}>
            {selected && (
              <>
