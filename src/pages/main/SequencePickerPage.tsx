...
export default function SequencePickerPage() {
  ...
  return (
    <div className="seqp-page">
      ...
      {/* Preview panel */}
      <div className={`seqp-preview ${selected ? 'seqp-preview-visible' : ''}`}>
        {selected && (
          <>
        ...
        {!selected && (
          <div className="seqp-preview-empty">
            <p className="text-body-sm text-tertiary">Select a sequence to preview</p>
          </div>
        )}
      </div>
    </div>
